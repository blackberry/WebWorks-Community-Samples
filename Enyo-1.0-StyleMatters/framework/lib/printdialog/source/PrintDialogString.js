var PrintDialogString = (function() {
	...
	var stringIDs = {
		...
		"COMMUNICATION_ERROR": rb.$L("Unable to communicate with the printer. Please make sure the printer is online and try again."),
		"NO_WIFI_CONNECTION": rb.$L("The Wi-Fi connection is unavailable. Please connect to a Wi-Fi network and try again.")
	};
